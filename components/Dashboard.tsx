      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 lg:mt-10 bg-white p-4 lg:p-6 rounded-xl shadow-lg">
          {isLoading ? (
            ...
            <>
              {storyboard?.videoSource && (
                <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-sm font-semibold text-blue-900 mb-1">Video Source</h3>
                      <p className="text-sm text-blue-700">{storyboard.videoSource.title}</p>
                    </div>
                    <a
                      href={storyboard.videoSource.url}
                      target="_blank"
